...
# -----------------------------
# Admin auth (simple cookie session)
# -----------------------------
ADMIN_USER = "moglot"
ADMIN_PASS = "12344321"
ADMIN_TOKEN = "ce01cc0c3f4fbf243ab7c9f9dd186030759a87dd8a9c8189b7a1ea64be5d0613"
...
def admin_login(username: str = Form(...), password: str = Form(...), remember: Optional[str] = Form(None)):
    if username != ADMIN_USER or password != ADMIN_PASS:
        # show same page with a small flag
        return HTMLResponse((APP_DIR / "templates" / "login.html").read_text(encoding="utf-8").replace("{{ERROR}}", "Невірний логін або пароль"), status_code=401)
