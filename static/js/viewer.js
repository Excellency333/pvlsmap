document.addEventListener("DOMContentLoaded", ()=>{
  ...
  const baseSatelliteHybrid = createPvlsMapTilerStyle('hybrid-v4', {language:'uk', enhanceLabels:true});
  const baseSatellite = createPvlsMapTilerStyle('satellite-v4', {language:false, enhanceLabels:false});
  ...
  const baseLayers = {
    ...
    '🛰 Супутник Hybrid 🇺🇦': baseSatelliteHybrid,
    '🛰 Супутник чистий': baseSatellite,
  };
  ...
  const layerKeyMap = {
    ...
    satellite_hybrid:baseSatelliteHybrid, satellite:baseSatellite
  };
  ...
  const isDarkBaseLayer = (layer)=> layer===baseDark || layer===baseSatelliteHybrid || layer===baseSatellite;
