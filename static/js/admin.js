document.addEventListener("DOMContentLoaded", ()=>{
  ...
  const baseSentinelFresh = L.tileLayer.wms('https://titiler.terrascope.be/wms', {
    layers:'terrascope-s2-toc-v2_tci', format:'image/png', transparent:false, version:'1.3.0',
    time:sentinel2TimeWindow(), maxZoom:20, maxNativeZoom:14,
  ...
  function setBaseLayer(layer){
    ...
    const isDark = (currentBase === baseDark || currentBase === baseSatellite || currentBase === baseSentinelFresh);
